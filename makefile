...
# To build 'toolsense_owrt', we depend on the object files, and link them all into a single executable using the compilation tool
# We use automatic variables to specify the final executable name 'toolsense_owrt', using '$@' and the '$^' will hold the names of all the
